...
<head>
  ...
  <title>Crear Usuario Webmin Docker Compose</title>
  ...
  <main id="main" class="main">
    ...
    <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" action="crearUsuario.php" method="POST">
                <div class="col-md-4">
                  <label for="inputName5" class="form-label">Nombre</label>
                  <input type="text" name="nombre" class="form-control" id="inputName5" placeholder="Nombre" required>
                </div>
                <div class="col-md-4">
                  <label for="inputApellido1" class="form-label">Apellido 1</label>
                  <input type="text" name="apellido1" class="form-control" id="inputApellido1" placeholder="Apellido 1" required>
                </div>
                <div class="col-md-4">
                  <label for="inputApellido2" class="form-label">Apellido 2</label>
                  <input type="text" name="apellido2" class="form-control" id="inputApellido2" placeholder="Apellido 2" required>
                </div>
                <div class="col-12">
                ...
                <div class="col-6">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="username" placeholder="Usuario" class="form-control" id="inputUsuario" required>
                      </div>
                    </div>
                <div class="col-md-6">
                ...
                <div class="row mb-3">
                  ...
                  <button type="submit" name="crear" value="crear" class="btn btn-next">Crear Usuario</button>
