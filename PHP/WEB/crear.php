...
if(isset($_POST["crear"]))
{
  ...
  if(isset($_POST["nombreServicio"]) && isset($_POST["descripcion"]))
  {
    ...
    {
      $params["servicio1"] = $_POST["apache2"];
      $params["servicio2"] = $_POST["mysql"];
      $params["servicio3"] = $_POST["nginx"];
      $params["servicio4"] = $_POST["mongo"];
